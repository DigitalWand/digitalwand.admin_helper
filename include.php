...
Loader::registerAutoLoadClasses('digitalwand.admin_helper',
    array(
        'DigitalWand\AdminHelper\AdminBaseHelper\Helper' => "lib/helper/AdminBaseHelper.php",
        'DigitalWand\AdminHelper\AdminListHelper\Helper' => "lib/helper/AdminListHelper.php",
        'DigitalWand\AdminHelper\AdminEditHelper\Helper' => "lib/helper/AdminEditHelper.php",
