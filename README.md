...
## Установка
- в папке [/dist/](/dist/) находятся две версии модуля, для utf-8 и windows-1251

## Создание архивов, для устаовки
- для создании сборки необходим `npm` и `gulp 4` (ставим `npm install`)
- выполняется `npm run gulp` или `gulp`
