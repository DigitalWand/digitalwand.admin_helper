 ...
 * ```
 * $filmManager = new EntityManager(FilmTable, array(
 *        // Данные сущности
 ...
 *        'RELATED_LINKS' => array(
 *        	// Переданный ниже массив будет обработан аналогично коду RelatedLinksTable::add(array('VALUE' => 'yandex.ru'));
 *        	array('VALUE' => 'yandex.ru'),
 *        	// Если в массив добавить ID, то запись обновится: RelatedLinksTable::update(3, array('ID' => 3, 'VALUE' => 'google.com'));
 *        	array('ID' => 3, 'VALUE' => 'google.com'),
 ...
 * ```
 * $articleManager = new EntityManager(ArticlesTable, array(), 7, $adminHelper);
 ...
 * ```
 * NewsLinksTable::add(array('ENTITY' => 'news', 'FIELD' => 'NEWS_LINKS', 'ENTITY_ID' => 'id сущности, например новости', 'LINK' => 'test.ru'));
 * NewsLinksTable::add(array('ENTITY' => 'news', 'FIELD' => 'NEWS_LINKS', 'ENTITY_ID' => 'id сущности', 'LINK' => 'test2.ru'));
 * NewsLinksTable::update('id ссылки', array('ENTITY' => 'news', 'FIELD' => 'NEWS_LINKS', 'ENTITY_ID' => 'id сущности', 'LINK' => 'test3.ru'));
 * ```
