 ...
 * <li><b>MULTIPLE</b> - bool является ли поле обязательным</li>
 * </ul>
 *
 * Инструкция по реализации множественных полей:
 * <ul>
 * <li>создайте поле и пометьте MULTIPLE true</li>
 * <li>создайте таблицу для сущности поля. Обязательные поля: ID (INT), ENTITY_ID (INT), VALUE(нужный размер, обычно 512)
